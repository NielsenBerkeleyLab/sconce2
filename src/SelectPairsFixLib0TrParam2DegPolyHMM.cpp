...
/*
 * function to reset values in paramsToEst that weren't actually estimated. that is, there wasn't an HMM corresponding to those branch lengths, so setting to -1 to be clear they weren't set by BFGS estimation
 */
